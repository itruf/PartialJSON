...
struct PartialJSONTests {
    ...
    @Test func shouldParsePartialJSON() async throws {
        // Test partial object
        let result1 = try parseJSON("{\"field")
        ...
        let result4 = try parseJSON("{\"field\": true, \"field2\"")
        ...
        let result5 = try parseJSON("{\"field\": true, \"field2\":")
        ...
        let result6 = try parseJSON("{\"field\": true, \"field2\":{")
        ...
        let result7 = try parseJSON("{\"field\": true, \"field2\": { \"obj\": \"somestr\"")
        ...
        let result8 = try parseJSON("{\"field\": true, \"field2\": { \"obj\": \"somestr\",")
        ...
        let result9 = try parseJSON("{\"field\": \"va")
        ...
        let result10 = try parseJSON("[ \"v1\", 2, \"v2\", 3")
        ...
        let result11 = try parseJSON("[ \"v1\", 2, \"v2\", -")
        ...
        let result12 = try parseJSON("[1, 2e")
    ...
    @Test func shouldOnlyThrowErrorsForPartialNumbers() async throws {
        ...
        for jsonString in problematicCases {
            do {
                _ = try parseJSON(jsonString, options: .all.subtracting(.number))
    ...
    @Test func shouldThrowErrorForIncompleteNumberWithDefaultOptions() async throws {
        ...
        let result = try parseJSON("1.", options: .all)
    ...
    @Test func shouldAllowPartialNumbersWhenEnabled() async throws {
        ...
        for (jsonString, expected) in allowedCases {
            let result = try parseJSON(jsonString, options: .all)
            if let number = result as? Double {
    ...
    @Test func shouldHandleSpecialValues() async throws {
        ...
        let result1 = try parseJSON("t", options: .all)
        #expect(result1 as? Bool == true)
        
        let result2 = try parseJSON("f", options: .all)
        #expect(result2 as? Bool == false)
        
        // Test partial null
        let result3 = try parseJSON("n", options: .all)
        #expect(result3 is NSNull)
        
        // Test partial Infinity
        let result4 = try parseJSON("I", options: .all)
        ...
        // Test partial -Infinity
        let result5 = try parseJSON("-I", options: .all)
        ...
        // Test partial NaN
        let result6 = try parseJSON("N", options: .all)
    ...
    @Test func shouldRespectOptions() async throws {
        ...
        do {
            _ = try parseJSON("t", options: .all.subtracting(.boolean))
        ...
        do {
            _ = try parseJSON("n", options: .all.subtracting(.null))
